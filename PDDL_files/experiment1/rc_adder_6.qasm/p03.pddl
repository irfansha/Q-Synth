...
(:goal
 ...
 (not (X q0 q0))(not (X q0 q1))(not (X q0 q2))(not (X q0 q3))     (X q0 q4) (not (X q0 q5))(not (X q0 q6))(not (X q0 q7))(not (X q0 q8))(not (X q0 q9))(not (X q0 q10))(not (X q0 q11))(not (X q0 q12))(not (X q0 q13))
      (X q1 q0) (not (X q1 q1))(not (X q1 q2))(not (X q1 q3))     (X q1 q4) (not (X q1 q5))(not (X q1 q6))(not (X q1 q7))(not (X q1 q8))(not (X q1 q9))(not (X q1 q10))(not (X q1 q11))(not (X q1 q12))(not (X q1 q13))
 ...
 (not (X q3 q0))(not (X q3 q1))(not (X q3 q2))     (X q3 q3) (not (X q3 q4))(not (X q3 q5))(not (X q3 q6))(not (X q3 q7))(not (X q3 q8))(not (X q3 q9))(not (X q3 q10))(not (X q3 q11))(not (X q3 q12))(not (X q3 q13))
      (X q4 q0)      (X q4 q1) (not (X q4 q2))(not (X q4 q3))     (X q4 q4) (not (X q4 q5))(not (X q4 q6))(not (X q4 q7))(not (X q4 q8))(not (X q4 q9))(not (X q4 q10))(not (X q4 q11))(not (X q4 q12))(not (X q4 q13))
