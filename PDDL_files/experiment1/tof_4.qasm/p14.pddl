...
(:goal
 ...
 (not (X q4 q0))     (X q4 q1) (not (X q4 q2))(not (X q4 q3))     (X q4 q4) (not (X q4 q5))(not (X q4 q6))
 (not (X q5 q0))(not (X q5 q1))(not (X q5 q2))(not (X q5 q3))     (X q5 q4) (not (X q5 q5))(not (X q5 q6))
