...
(:goal
 ...
 (not (X q2 q0))     (X q2 q1) (not (X q2 q2))(not (X q2 q3))(not (X q2 q4))     (X q2 q5) (not (X q2 q6))
 ...
 (not (X q5 q0))     (X q5 q1) (not (X q5 q2))(not (X q5 q3))(not (X q5 q4))(not (X q5 q5))(not (X q5 q6))
