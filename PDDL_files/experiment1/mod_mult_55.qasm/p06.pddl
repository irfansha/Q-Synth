...
(:goal
 ...
 (not (X q2 q0))(not (X q2 q1))     (X q2 q2) (not (X q2 q3))     (X q2 q4) (not (X q2 q5))(not (X q2 q6))(not (X q2 q7))(not (X q2 q8))
 (not (X q3 q0))(not (X q3 q1))(not (X q3 q2))(not (X q3 q3))     (X q3 q4) (not (X q3 q5))     (X q3 q6)      (X q3 q7) (not (X q3 q8))
 ...
 (not (X q7 q0))(not (X q7 q1))(not (X q7 q2))     (X q7 q3)      (X q7 q4) (not (X q7 q5))(not (X q7 q6))     (X q7 q7) (not (X q7 q8))
