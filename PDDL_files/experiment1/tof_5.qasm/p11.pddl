...
(:goal
 ...
 (not (X q4 q0))(not (X q4 q1))(not (X q4 q2))(not (X q4 q3))     (X q4 q4) (not (X q4 q5))(not (X q4 q6))(not (X q4 q7))     (X q4 q8) 
 (not (X q5 q0))(not (X q5 q1))(not (X q5 q2))(not (X q5 q3))(not (X q5 q4))     (X q5 q5) (not (X q5 q6))(not (X q5 q7))(not (X q5 q8))
 (not (X q6 q0))(not (X q6 q1))(not (X q6 q2))(not (X q6 q3))(not (X q6 q4))(not (X q6 q5))     (X q6 q6) (not (X q6 q7))     (X q6 q8) 
 (not (X q7 q0))(not (X q7 q1))(not (X q7 q2))(not (X q7 q3))(not (X q7 q4))(not (X q7 q5))(not (X q7 q6))     (X q7 q7) (not (X q7 q8))
 (not (X q8 q0))(not (X q8 q1))(not (X q8 q2))(not (X q8 q3))     (X q8 q4) (not (X q8 q5))     (X q8 q6) (not (X q8 q7))     (X q8 q8) 
  )
)
)