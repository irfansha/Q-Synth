...
(:goal
 ...
 (not (X q2 q0))(not (X q2 q1))     (X q2 q2)      (X q2 q3) (not (X q2 q4))(not (X q2 q5))     (X q2 q6) (not (X q2 q7))(not (X q2 q8))
 ...
 (not (X q6 q0))(not (X q6 q1))     (X q6 q2)      (X q6 q3) (not (X q6 q4))(not (X q6 q5))(not (X q6 q6))(not (X q6 q7))(not (X q6 q8))
