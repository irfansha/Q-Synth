...
(:goal
 ...
 (not (X q3 q0))(not (X q3 q1))(not (X q3 q2))     (X q3 q3) (not (X q3 q4))(not (X q3 q5))(not (X q3 q6))(not (X q3 q7))(not (X q3 q8))(not (X q3 q9))     (X q3 q10) (not (X q3 q11))(not (X q3 q12))(not (X q3 q13))
 ...
 (not (X q5 q0))(not (X q5 q1))(not (X q5 q2))(not (X q5 q3))     (X q5 q4) (not (X q5 q5))     (X q5 q6) (not (X q5 q7))(not (X q5 q8))(not (X q5 q9))(not (X q5 q10))     (X q5 q11) (not (X q5 q12))(not (X q5 q13))
 ...
 (not (X q9 q0))(not (X q9 q1))(not (X q9 q2))(not (X q9 q3))(not (X q9 q4))     (X q9 q5) (not (X q9 q6))(not (X q9 q7))(not (X q9 q8))(not (X q9 q9))(not (X q9 q10))(not (X q9 q11))(not (X q9 q12))(not (X q9 q13))
 (not (X q10 q0))(not (X q10 q1))(not (X q10 q2))(not (X q10 q3))(not (X q10 q4))(not (X q10 q5))(not (X q10 q6))(not (X q10 q7))     (X q10 q8)      (X q10 q9) (not (X q10 q10))(not (X q10 q11))(not (X q10 q12))(not (X q10 q13))
