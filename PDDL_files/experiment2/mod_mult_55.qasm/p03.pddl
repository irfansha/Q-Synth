...
(:goal
 ...
 (not (X q5 q0))(not (X q5 q1))(not (X q5 q2))(not (X q5 q3))     (X q5 q4)      (X q5 q5)      (X q5 q6) (not (X q5 q7))(not (X q5 q8))(not (X q5 q9))(not (X q5 q10))(not (X q5 q11))(not (X q5 q12))(not (X q5 q13))
 ...
 (not (X q10 q0))(not (X q10 q1))(not (X q10 q2))(not (X q10 q3))     (X q10 q4) (not (X q10 q5))(not (X q10 q6))(not (X q10 q7))(not (X q10 q8))     (X q10 q9)      (X q10 q10) (not (X q10 q11))     (X q10 q12) (not (X q10 q13))
