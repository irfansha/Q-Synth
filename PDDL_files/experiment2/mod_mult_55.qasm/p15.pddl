...
(:goal
 ...
 (not (X q2 q0))(not (X q2 q1))     (X q2 q2)      (X q2 q3) (not (X q2 q4))(not (X q2 q5))(not (X q2 q6))(not (X q2 q7))(not (X q2 q8))(not (X q2 q9))(not (X q2 q10))(not (X q2 q11))(not (X q2 q12))(not (X q2 q13))
 ...
 (not (X q8 q0))(not (X q8 q1))(not (X q8 q2))(not (X q8 q3))     (X q8 q4) (not (X q8 q5))(not (X q8 q6))(not (X q8 q7))(not (X q8 q8))     (X q8 q9)      (X q8 q10) (not (X q8 q11))(not (X q8 q12))(not (X q8 q13))
 (not (X q9 q0))(not (X q9 q1))(not (X q9 q2))(not (X q9 q3))     (X q9 q4) (not (X q9 q5))(not (X q9 q6))(not (X q9 q7))     (X q9 q8)      (X q9 q9)      (X q9 q10) (not (X q9 q11))(not (X q9 q12))(not (X q9 q13))
 (not (X q10 q0))(not (X q10 q1))(not (X q10 q2))(not (X q10 q3))     (X q10 q4) (not (X q10 q5))(not (X q10 q6))(not (X q10 q7))     (X q10 q8) (not (X q10 q9))     (X q10 q10) (not (X q10 q11))(not (X q10 q12))(not (X q10 q13))
