...
(:goal
 ...
 (not (X q4 q0))(not (X q4 q1))(not (X q4 q2))(not (X q4 q3))(not (X q4 q4))     (X q4 q5) (not (X q4 q6))(not (X q4 q7))(not (X q4 q8))(not (X q4 q9))(not (X q4 q10))(not (X q4 q11))(not (X q4 q12))(not (X q4 q13))
 (not (X q5 q0))(not (X q5 q1))(not (X q5 q2))(not (X q5 q3))     (X q5 q4) (not (X q5 q5))(not (X q5 q6))(not (X q5 q7))(not (X q5 q8))(not (X q5 q9))(not (X q5 q10))(not (X q5 q11))(not (X q5 q12))(not (X q5 q13))
 (not (X q6 q0))(not (X q6 q1))(not (X q6 q2))(not (X q6 q3))(not (X q6 q4))(not (X q6 q5))     (X q6 q6) (not (X q6 q7))     (X q6 q8) (not (X q6 q9))(not (X q6 q10))(not (X q6 q11))(not (X q6 q12))(not (X q6 q13))
 ...
 (not (X q9 q0))(not (X q9 q1))(not (X q9 q2))(not (X q9 q3))     (X q9 q4) (not (X q9 q5))(not (X q9 q6))(not (X q9 q7))(not (X q9 q8))     (X q9 q9) (not (X q9 q10))(not (X q9 q11))(not (X q9 q12))(not (X q9 q13))
