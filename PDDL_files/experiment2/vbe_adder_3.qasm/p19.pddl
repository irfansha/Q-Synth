...
(:goal
 ...
 (not (X q1 q0))     (X q1 q1) (not (X q1 q2))(not (X q1 q3))(not (X q1 q4))(not (X q1 q5))(not (X q1 q6))(not (X q1 q7))(not (X q1 q8))(not (X q1 q9))(not (X q1 q10))(not (X q1 q11))(not (X q1 q12))     (X q1 q13) 
 (not (X q2 q0))     (X q2 q1)      (X q2 q2) (not (X q2 q3))(not (X q2 q4))(not (X q2 q5))(not (X q2 q6))(not (X q2 q7))(not (X q2 q8))(not (X q2 q9))(not (X q2 q10))(not (X q2 q11))(not (X q2 q12))(not (X q2 q13))
 ...
 (not (X q12 q0))(not (X q12 q1))(not (X q12 q2))(not (X q12 q3))(not (X q12 q4))(not (X q12 q5))(not (X q12 q6))(not (X q12 q7))(not (X q12 q8))(not (X q12 q9))(not (X q12 q10))(not (X q12 q11))     (X q12 q12)      (X q12 q13) 
