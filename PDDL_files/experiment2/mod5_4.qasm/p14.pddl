...
(:goal
 ...
 (not (X q2 q0))(not (X q2 q1))(not (X q2 q2))     (X q2 q3) (not (X q2 q4))(not (X q2 q5))(not (X q2 q6))(not (X q2 q7))(not (X q2 q8))(not (X q2 q9))(not (X q2 q10))(not (X q2 q11))(not (X q2 q12))(not (X q2 q13))
 (not (X q3 q0))(not (X q3 q1))     (X q3 q2) (not (X q3 q3))(not (X q3 q4))(not (X q3 q5))(not (X q3 q6))(not (X q3 q7))(not (X q3 q8))(not (X q3 q9))(not (X q3 q10))(not (X q3 q11))(not (X q3 q12))(not (X q3 q13))
 ...
 (not (X q11 q0))(not (X q11 q1))(not (X q11 q2))     (X q11 q3) (not (X q11 q4))(not (X q11 q5))(not (X q11 q6))(not (X q11 q7))(not (X q11 q8))(not (X q11 q9))(not (X q11 q10))     (X q11 q11) (not (X q11 q12))(not (X q11 q13))
 (not (X q12 q0))(not (X q12 q1))(not (X q12 q2))     (X q12 q3) (not (X q12 q4))(not (X q12 q5))(not (X q12 q6))(not (X q12 q7))(not (X q12 q8))(not (X q12 q9))(not (X q12 q10))(not (X q12 q11))     (X q12 q12) (not (X q12 q13))
