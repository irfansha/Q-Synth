...
(:goal
 ...
 (not (X q3 q0))(not (X q3 q1))(not (X q3 q2))(not (X q3 q3))     (X q3 q4) (not (X q3 q5))(not (X q3 q6))(not (X q3 q7))(not (X q3 q8))(not (X q3 q9))     (X q3 q10) (not (X q3 q11))     (X q3 q12) (not (X q3 q13))
 (not (X q4 q0))(not (X q4 q1))(not (X q4 q2))(not (X q4 q3))(not (X q4 q4))(not (X q4 q5))(not (X q4 q6))(not (X q4 q7))(not (X q4 q8))(not (X q4 q9))     (X q4 q10)      (X q4 q11) (not (X q4 q12))(not (X q4 q13))
 ...
 (not (X q10 q0))(not (X q10 q1))(not (X q10 q2))     (X q10 q3)      (X q10 q4) (not (X q10 q5))(not (X q10 q6))(not (X q10 q7))(not (X q10 q8))(not (X q10 q9))     (X q10 q10)      (X q10 q11) (not (X q10 q12))(not (X q10 q13))
 (not (X q11 q0))(not (X q11 q1))(not (X q11 q2))     (X q11 q3)      (X q11 q4) (not (X q11 q5))(not (X q11 q6))(not (X q11 q7))(not (X q11 q8))(not (X q11 q9))     (X q11 q10) (not (X q11 q11))     (X q11 q12) (not (X q11 q13))
