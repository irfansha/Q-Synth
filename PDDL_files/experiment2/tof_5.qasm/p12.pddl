...
(:goal
 ...
 (not (X q6 q0))(not (X q6 q1))(not (X q6 q2))(not (X q6 q3))(not (X q6 q4))(not (X q6 q5))(not (X q6 q6))(not (X q6 q7))     (X q6 q8) (not (X q6 q9))(not (X q6 q10))(not (X q6 q11))(not (X q6 q12))(not (X q6 q13))
 (not (X q7 q0))(not (X q7 q1))(not (X q7 q2))(not (X q7 q3))(not (X q7 q4))(not (X q7 q5))     (X q7 q6)      (X q7 q7) (not (X q7 q8))(not (X q7 q9))(not (X q7 q10))(not (X q7 q11))(not (X q7 q12))(not (X q7 q13))
 (not (X q8 q0))(not (X q8 q1))(not (X q8 q2))(not (X q8 q3))(not (X q8 q4))(not (X q8 q5))     (X q8 q6) (not (X q8 q7))(not (X q8 q8))(not (X q8 q9))(not (X q8 q10))(not (X q8 q11))(not (X q8 q12))(not (X q8 q13))
