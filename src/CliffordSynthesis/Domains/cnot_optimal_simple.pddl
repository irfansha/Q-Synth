...
;; ==================================================================
;; Layer single qubit gates layer actions, we only need h-gate and s-gate, to allow all combinations:
;; since we can disable any qubit before a cnot application, we get all the combinations needed.
;; apply a gate and disable that qubit:
;; ==================================================================

;; disable any gate, for termination:
(:action disable
:parameters (?i - qubit)
:precondition (and (not (disabled ?i)))
