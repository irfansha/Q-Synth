...
def layout_synthesis(
    ...
    if model == "planning":
        match metric:
            case "cx-count":
                model = "local"
            case "cx-depth" | "depth" | "depth-cx-count" | "cx-depth-cx-count":
                model = "cond_cost_opt"
    ...
    match metric:
        ...
        case "cx-count":
            from src.LayoutSynthesis.layout_synthesis import layout_synthesis as ls
        ...
        case "cx-depth" | "depth" | "depth-cx-count" | "cx-depth-cx-count":
            ...
            return depth_optimal_mapping(
                ...
                solver_name=solver,
                solver_time=solver_time,
                cx_optimal=(metric in ("cx-depth", "cx-depth-cx-count")),
                swap_optimal=(metric in ("depth-cx-count", "cx-depth-cx-count")),
                allow_ancillas=allow_ancillas,
                verbose=verbose,
